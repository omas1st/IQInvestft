...
export default function Header(){
  ...
  // Path to public/logo192.png — served at /logo192.png
        ...
        <div className="container header-inner">
          <div className="brand-area">
            <Link to="/" className="brand">
              {/* Replaced brand-mark with logo from public/logo192.png */}
              <img src={logoPath} className="brand-logo" alt="IQMinersInvest logo" />
              <span className="brand-text">IQMINERSINVEST</span>
            </Link>
