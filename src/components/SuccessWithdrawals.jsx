...
const FIRST_NAMES = [
  ...
  'James', 'John', 'Robert', 'Michael', 'William', 'David', 'Joseph', 'Thomas', 'Christopher', 'Daniel',
  'Mary', 'Patricia', 'Jennifer', 'Linda', 'Elizabeth', 'Barbara', 'Susan', 'Jessica', 'Sarah', 'Karen',

  // Canadian first names (mix of English and French)
  'Liam', 'Noah', 'William', 'James', 'Oliver', 'Olivia', 'Emma', 'Charlotte', 'Amelia', 'Ava',
  'Olivier', 'Émile', 'Léo', 'Nathan', 'Thomas', 'Alice', 'Léa', 'Florence', 'Rosalie', 'Juliette'
]

const SURNAMES = [
  // Original South African surnames
  ...
  // Canadian surnames (mix of English and French)
  'Smith', 'Brown', 'Tremblay', 'Gagnon', 'Roy', 'Côté', 'Bouchard', 'Gauthier', 'Morin', 'Lavoie',
  'Fortin', 'Gagné', 'Ouellet', 'Pelletier', 'Bélanger', 'Lévesque', 'Bergeron', 'Leblanc', 'Paquette', 'Girard'
]
...
export default function SuccessWithdrawals() {
  ...
  return (
    <div className="withdrawals-wrapper">
      {/* ✅ Added header */}
      <h2 className="recent-withdrawals-header">Recent Withdrawals</h2>
